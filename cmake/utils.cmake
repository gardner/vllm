...
function(cuda_archs_loose_intersection OUT_CUDA_ARCHS SRC_CUDA_ARCHS TGT_CUDA_ARCHS)
  ...
  set(_ALLOW_CROSS_MAJOR_PTX_FALLBACK TRUE)
  if(DEFINED VLLM_NATIVE_CUDA_ARCHS_ONLY AND VLLM_NATIVE_CUDA_ARCHS_ONLY)
    set(_ALLOW_CROSS_MAJOR_PTX_FALLBACK FALSE)
  endif()
  ...
  foreach(_ARCH ${_TGT_CUDA_ARCHS})
    ...
    foreach(_SRC_ARCH ${_SRC_CUDA_ARCHS})
      ...
      if (_SRC_ARCH VERSION_LESS_EQUAL _ARCH)
        if (SRC_ARCH_MAJOR STREQUAL TGT_ARCH_MAJOR OR
            (_ALLOW_CROSS_MAJOR_PTX_FALLBACK AND _SRC_ARCH IN_LIST _PTX_ARCHS))
