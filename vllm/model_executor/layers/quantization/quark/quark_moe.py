...
from vllm.model_executor.layers.quantization.quark.utils import (
    ...
    gb10_quark_w4a8_fp8_moe_unsupported_reason,
    gb10_quark_w8a8_fp8_moe_unsupported_reason,
    gb10_quark_w8a8_int8_moe_unsupported_reason,
)
...
class QuarkW8A8Fp8MoEMethod(QuarkMoEMethod):
    def __init__(
        ...
        unsupported_reason = gb10_quark_w8a8_fp8_moe_unsupported_reason()
...
class QuarkW8A8Int8MoEMethod(QuarkMoEMethod):
    ...
    def __init__(
        ...
        unsupported_reason = gb10_quark_w8a8_int8_moe_unsupported_reason()
        if unsupported_reason is not None:
            raise ValueError(unsupported_reason)
...
class QuarkW4A8Fp8MoEMethod(QuarkMoEMethod):
    def __init__(
        ...
        unsupported_reason = gb10_quark_w4a8_fp8_moe_unsupported_reason()
        if unsupported_reason is not None:
            raise ValueError(unsupported_reason)
